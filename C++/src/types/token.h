#ifndef PILO_PARSIN_H_
#define PILO_PARSIN_H_

// TODO: Create following things:
...
namespace Pilo {
  ...
  class PILO_EXPORT_PRIVATE Token {
  public:
    // All token values.
  ...
  #undef T
    ...
    PILO_INLINE static bool IsValidIdentifier(Value token,
                                            LanguageMode language_mode,
                                            bool is_generator,
                                            bool disallow_await) {
      if (PILO_LIKELY(base::IsInRange(token, IDENTIFIER, ASYNC))) return true;
